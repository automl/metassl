...
from metassl.baselines.simsiam.resnet_cifar import ResNet18, ResNet34, ResNet50, ResNet101, ResNet152
...
def main_worker(gpu, ngpus_per_node, args, logger=None, trial_dir=None, bohb_infos=None):
    ...
    for epoch in range(args.start_epoch, args.ft_epochs):
        ...
        # train for one epoch
        train(train_loader, model, criterion, optimizer, epoch, args, bohb_infos, logger=logger)
...
def train(train_loader, model, criterion, optimizer, epoch, args, bohb_infos, logger=None):
