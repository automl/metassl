...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--expt.expt_mode",
        default="ImageNet",
        choices=["ImageNet", "CIFAR10", "ImageNet_BOHB", "CIFAR10_BOHB"],
    ...
    # fmt: off
    # parser.add_argument('--bohb', default="bohb", type=str, metavar='N')  # noqa: E501, E241
    # parser.add_argument("--bohb.run_id", default="default_BOHB")  # noqa: E501, E241
    # parser.add_argument("--bohb.seed", type=int, default=123, help="random seed")  # noqa: E501, E241
    # parser.add_argument("--bohb.n_iterations", type=int, default=10, help="How many BOHB iterations")  # noqa: E501, E241
    # parser.add_argument("--bohb.min_budget", type=int, default=2)  # noqa: E501, E241
    # parser.add_argument("--bohb.max_budget", type=int, default=4)  # noqa: E501, E241
    # parser.add_argument("--bohb.budget_mode", type=str, default="epochs", choices=["epochs", "data"], help="Choose your desired fidelity")  # noqa: E501, E241
    # parser.add_argument("--bohb.eta", type=int, default=2)  # noqa: E501, E241
    # parser.add_argument("--bohb.configspace_mode", type=str, default='color_jitter_strengths', choices=["imagenet_probability_simsiam_augment", "cifar10_probability_simsiam_augment", "color_jitter_strengths", "rand_augment", "probability_augment", "double_probability_augment"], help='Define which configspace to use.')  # noqa: E501, E241
    # parser.add_argument("--bohb.nic_name", default="lo", help="The network interface to use")  # noqa: E501, E241  # local: "lo", cluster: "eth0"
    # parser.add_argument("--bohb.port", type=int, default=0, help="Add port for BOHB")  # noqa: E501, E241
    # parser.add_argument("--bohb.worker", action="store_true", help="Make this execution a worker server")  # noqa: E501, E241
    # parser.add_argument("--bohb.warmstarting", type=bool, default=False)  # noqa: E501, E241
    # parser.add_argument("--bohb.warmstarting_dir", type=str, default=None)  # noqa: E501, E241
    # parser.add_argument("--bohb.test_env", action='store_true', help='If using this flag, the master runs a worker in the background and workers are not being shutdown after registering results.')  # noqa: E501, E241
    # fmt: on
    ...
    parser.add_argument(
        "--neps.config_space",
        type=str,
        default="parameterized_cifar10_augmentation",
        choices=["parameterized_cifar10_augmentation", "probability_augment"],
