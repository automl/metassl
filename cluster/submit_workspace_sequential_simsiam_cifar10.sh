...
python -m metassl.baselines.execute_pt_and_ft --gpu 0 --valid_size 0.0 --seed 1 --pt_learning_rate 0.06 --trial $EXPERIMENT_NAME --exp_dir "/work/dlclarge2/wagnerd-metassl_experiments/CIFAR10" --pretrained /work/dlclarge2/wagnerd-metassl_experiments/CIFAR10/$EXPERIMENT_NAME/$EXPERIMENT_NAME --do_weight_decay_annealing
